...
export interface GlbMessage {
  type: "GlbMessage";
  name: string;
  props: {'glb_data': Uint8Array<ArrayBuffer>, 'scale': (number | [number, number, number]), 'cast_shadow': boolean, 'receive_shadow': (boolean | number)};
}
...
export interface MeshMessage {
  type: "MeshMessage";
  name: string;
  props: {'vertices': Uint8Array<ArrayBuffer>, 'faces': Uint8Array<ArrayBuffer>, 'color': [number, number, number], 'wireframe': boolean, 'opacity': (number | null), 'flat_shading': boolean, 'side': 'front' | 'back' | 'double', 'material': 'standard' | 'toon3' | 'toon5', 'scale': (number | [number, number, number]), 'cast_shadow': boolean, 'receive_shadow': (boolean | number)};
}
/** Box message.
 *
 * (automatically generated)
...
export interface CylinderMessage {
  ...
  name: string;
  props: {'radius': number, 'height': number, 'color': [number, number, number], 'radial_segments': number, 'wireframe': boolean, 'opacity': (number | null), 'flat_shading': boolean, 'side': 'front' | 'back' | 'double', 'material': 'standard' | 'toon3' | 'toon5', 'cast_shadow': boolean, 'receive_shadow': (boolean | number)};
}
...
export interface SkinnedMeshMessage {
  ...
  name: string;
  props: {'vertices': Uint8Array<ArrayBuffer>, 'faces': Uint8Array<ArrayBuffer>, 'color': [number, number, number], 'wireframe': boolean, 'opacity': (number | null), 'flat_shading': boolean, 'side': 'front' | 'back' | 'double', 'material': 'standard' | 'toon3' | 'toon5', 'scale': (number | [number, number, number]), 'cast_shadow': boolean, 'receive_shadow': (boolean | number), 'bone_wxyzs': Uint8Array<ArrayBuffer>, 'bone_positions': Uint8Array<ArrayBuffer>, 'skin_indices': Uint8Array<ArrayBuffer>, 'skin_weights': Uint8Array<ArrayBuffer>};
}
...
export interface BatchedMeshesMessage {
  ...
  name: string;
  props: {'batched_wxyzs': Uint8Array<ArrayBuffer>, 'batched_positions': Uint8Array<ArrayBuffer>, 'batched_scales': (Uint8Array<ArrayBuffer> | null), 'lod': ('auto' | 'off' | [number, number][]), 'vertices': Uint8Array<ArrayBuffer>, 'faces': Uint8Array<ArrayBuffer>, 'batched_colors': Uint8Array<ArrayBuffer>, 'wireframe': boolean, 'opacity': (number | null), 'flat_shading': boolean, 'side': 'front' | 'back' | 'double', 'material': 'standard' | 'toon3' | 'toon5', 'cast_shadow': boolean, 'receive_shadow': boolean, 'batched_opacities': (Uint8Array<ArrayBuffer> | null)};
}
...
export interface SetTriangleSplatsMessage {
  ...
  name: string;
  props: {'vertices': Uint8Array<ArrayBuffer>, 'triangle_indices': Uint8Array<ArrayBuffer>, 'opacities': Uint8Array<ArrayBuffer>, 'vertex_weights': (Uint8Array<ArrayBuffer> | null), 'colors': (Uint8Array<ArrayBuffer> | null), 'features_dc': (Uint8Array<ArrayBuffer> | null), 'features_rest': (Uint8Array<ArrayBuffer> | null), 'sh_degree': number, 'sigma': number};
}
...
export interface GuiButtonMessage {
  ...
  value: boolean;
  container_uuid: string;
  props: {'order': number, 'label': string, 'hint': (string | null), 'visible': boolean, 'disabled': boolean, 'color': ('dark' | 'gray' | 'red' | 'pink' | 'grape' | 'violet' | 'indigo' | 'blue' | 'cyan' | 'green' | 'lime' | 'yellow' | 'orange' | 'teal' | [number, number, number] | null), '_icon_html': (string | null), '_hold_callback_freqs': number[]};
}
